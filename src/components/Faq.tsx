...
const faqData = [
  {
    ...
    answer: "É uma terapia breve e focada que atua diretamente na raiz dos problemas emocionais, como traumas, fobias, ansiedade e depressão, buscando a resolução definitiva do conflito psíquico."
  },
  {
    question: "Quantas sessões são necessárias?",
    answer: "A TRG é conhecida por sua eficácia em um curto período. O número de sessões varia conforme a necessidade individual, mas muitos clientes relatam melhoras significativas em poucas semanas."
  },
  {
    question: "A TRG é indicada para mim?",
    answer: "Se você sente que bloqueios emocionais, medos ou traumas do passado estão impactando sua vida hoje, a TRG pode ser uma ferramenta poderosa para sua transformação. Agende uma conversa para avaliarmos juntos."
  }
];
...
function Faq() {
  ...
  return (
    <section className={styles.faqSection}>
      <h2>Perguntas Frequentes sobre TRG</h2>
      <div className={styles.faqContentWrapper}>
        ...
        <div className={styles.faqContact}>
          <h3>Pronta para dar o primeiro passo?</h3>
          <p>Entre em contato e agende uma sessão. Estou aqui para te ajudar a encontrar o caminho para uma vida mais plena e feliz.</p>
